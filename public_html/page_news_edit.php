...
<body class="vertical-layout page-header-light vertical-menu-collapsible vertical-dark-menu preload-transitions 2-columns   " data-open="click" data-menu="vertical-dark-menu" data-col="2-columns">
    <?php
    include 'index.php';
    $select = select($database, $table_name,["id"],[$_GET['id']],"titulo,conteudo,url_noticia");

    $titulo = $select[0]["titulo"];
    $conteudo = $select[0]["conteudo"];
    $url_noticia = $select[0]["url_noticia"];
            ...
            <div class="container">
                    <div class="row">
                        <div class="col s12 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>Editar Matéria</span></h5>
                        </div>
                        <div class="col s12 m6 l6 right-align-md">
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="page_list_news.php">Lista de Notícias</a>
                                </li>
                                <li class="breadcrumb-item active">Editar Matéria
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="col l8 s12">
                                ...
                                <div id="general">
                                    <div class="card-panel">
                                        <form class="formValidate" method="post" action="page_news_edit_process.php">
                                            <div class="row">
                                                <div class="col s12">
                                                    <div class="input-field">
                                                        <input type="hidden" name="id_noticias" id="hiddenField" value="<?php echo $id_noticia ?>" />                                                
                                                    </div>
                                                    <div class="input-field">
                                                        <label for="titulo">Título</label>
                                                        <input type="text" id="titulo" name="titulo" data-error=".errorTxt1" placeholder=<?php echo $titulo; ?>>
                                                ...
                                                <div class="col s12">
                                                    <div class="input-field">
                                                        ...
                                                        <textarea id="conteudo" name="conteudo" type="text" data-error=".errorTxt2" placeholder=<?php echo $conteudo; ?>>
                                                        </textarea>
                                                ...
                                                <div class="col s12">
                                                    <div class="input-field">
                                                        ...
                                                        <input id="url_noticia" type="text" name="url_noticia"data-error=".errorTxt3"placeholder=<?php echo $url_noticia; ?>>
